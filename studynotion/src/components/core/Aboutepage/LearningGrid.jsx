...
export const LearningGrid = () => {
 ...
 return(
        <div className='grid mx-auto lg-grid-cols-4 mb-10 w-11/12 max-w-maxContent'>
            {
                LearningGridArray.map((card,index)=>{
                      return(
                        ...
                        ${
                            card.order % 2 === 1 ? "bg-gray-700" : "bg-gray-900 lg:h-[300px] p-5" 
                        }
                        ${card.order === 3 && "lg-col-satrt-2"}
