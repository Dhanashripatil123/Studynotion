       ...
       return(
              ...
              <div className=" w-50% text-justify ml-15 mt-5 gap-9">
               <div>
                     ...
                     <p className="text-[#383a3c] mt-4">
                       Build skills for today, tomorrow, and beyond.
                     </p>
                     <p className="text-[#3EBEFF]  font-poppins mt-4">
               ...
               <div className="flex flex-row ">
                ...
                <div className="flex flex-row gap-8">
                   <p className="flex flex-col">
                      <p className="text-white mt-4">Create Password</p>
                      <input
                ...
                <p className="w-1xl px-4 py-2">
                   <p className="text-black bg-yellow-500 justify-center rounded-2xl w-1xl px-4 py-2">
                      Signup
                   </p>
                </p>
                </div>
