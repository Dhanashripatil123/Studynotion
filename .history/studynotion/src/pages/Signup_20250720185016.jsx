               ...
               <div className="flex flex-row gap-x-3">
                ...
                <div className="flex flex-row gap-8 mt-4">
                   ...
                   <p className="flex flex-col">
                    ...
                    onClick =  {showPassword ? showConfirm : <p className="text-red-600 font-1xl">password is not match</p>}
                  
                  </div>
                  
                <p className="px-4 py-2 mt-4 ">
                   <label className="text-black bg-yellow-500 text-center rounded-2xl  px-4 py-2">
                      Signup
                   </label>
                </p>
                </div>
