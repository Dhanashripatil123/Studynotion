const Signup = ()=>{
       return(
              ...
              <div className=" w-50% text-justify ml-15 mt-5 ">
                     ...
                     <p className="py-1 px-1 gap-3 rounded-full flex flex-row bg-[#808487]">
                        <p className=" text-[#0b0c0c]">
                             Student 
                         </p>
                                                                                                                                                                                                               <p className=" text-[#0b0c0c]     --font-sans: ui-sans-serif, system-ui, sans-serif, " Apple Color Emoji",
