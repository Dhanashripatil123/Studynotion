...
codeColor={"text-yellow-25"}
      ...
      <div className='bg-[#dadce0] text-black'>
        ...
        <div className='flex flex-col md:flex-row  items-center mx-auto w-11 /12 max-w-maxContent  justify-between gap-7'>
          <div className=' w-full md:w-[45%] flex flex-row gap-5 '>
            Get the skill you need for
          <div className='text-4xl flex flex-row font-semibold w-[45%]'>
        ...
        <div className='flex flex-col gap-10 w-[40%] items-start'>
          <div className='text-[16px flrx flex-row'>
