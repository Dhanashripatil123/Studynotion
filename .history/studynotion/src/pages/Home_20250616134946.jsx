...
codeColor={"text-yellow-25"}
      ...
      <div className='bg-[#dadce0] text-black'>
        <div className='homepage_bg h-[333px]'>
          <div className='w-11/12 max-w-maxContent flex  flexjustify-center items-center gap-5 mx-auto'>
      ...
      <div className=' mx-auto w-11 /12 max-w-maxContent flex lex-col item-center justify-between gap-5'>
        <div className='flex flex-row gap-5 mb-10 mt-[95px]'>
          <div className='text-4xl fount-semibold w-[45%]'>
