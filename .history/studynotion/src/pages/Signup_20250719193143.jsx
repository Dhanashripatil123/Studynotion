              ...
              <div className=" w-50% text-justify ml-15 mt-5 ">
               ...
               <div className="flex flex-row gap-8">
                  <p className="flex flex-col">
                     ...
                     <p className="rounded-full w-1xl bg-[#ffffff3f] text-white">Enter the first Name</p>  
                  </p>
                  <p className="flex flex-col">
                     <p className="text-white">last Name</p> 
                     <p className="placeholder rounded-xl w-1xl bg-[#ffffff3f] text-[#242323]">Enter the last Name</p>  
                  </p>
                   <input
                      type="text"
                      placeholder="First Name"
                      class="w-full px-4 py-2 bg-gray-700 text-white placeholder:text-gray-400 placeholder:font-medium rounded-full"
                   />
               </div>
             </div>
               </div> 
