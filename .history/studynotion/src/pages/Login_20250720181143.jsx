...
const Login = ()=>{
     ...
     const [showConfirm, setShowConfirm] = useState(false);   
       ...
       return(
              <div className="w-50% flex flex-row gap-70 items-center mt-46">
              <div className=" w-50% text-justify ml-15 mt-5 gap-9">
               <div>
                ...
                <div className="flex flex-row gap-8 mt-4">
                    <p className="flex flex-col">
                      ...
                      <input
                         ...
                         class="w-full w-fix px-4 py-2 bg-gray-700 text-white placeholder:text-gray-400 placeholder:font-medium rounded-2xl"
                      />
                      <span
                ...
                <p className="px-4 py-2 mt-5">
                   <p className="text-black bg-yellow-500 rounded-2xl text-center px-4 py-2">
                      Signup
                   </p>
                </p>
                </div>
