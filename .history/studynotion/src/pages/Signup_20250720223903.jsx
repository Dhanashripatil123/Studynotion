...
const Signup = ()=>{
   ...
   const handleSignup = () => {
      if (password !== confirmPassword) {
       ...
       return(
              <div className="w-50% flex-row gap-70 items-center mt-26">
              <div className=" w-50% text-justify ml-15 mt-5 gap-9 flex flex-col">
               <div>
                ...
                <div className="flex flex-row gap-8 mt-4">
                   ...
                   <p className="flex flex-col">
                     ...
                     <div className="flex flex-col">
                      {error && (
                         <p className="text-red-400 text-sm mt-2 font-1xl">{error}</p>
                      )}
                  
                  
                      <button
                         onClick={handleSignup}
                         className="bg-yellow-500 text-black text-center rounded-2xl px-4 py-2 font-semibold mt-4 w-full"
                      >
                         Signup
                      </button>
                      </div>
