...
codeColor={"text-yellow-25"}
    ...
    <div>
      <div className='w-11/12 mx-auto max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-black-900 text-white'>

        <InstructorSection></InstructorSection>

        <h2 className='text-center text-4xl font-semibold mt-10'>review from anther lerner</h2>
      </div>
    </div>
