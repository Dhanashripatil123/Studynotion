              ...
              <h1 className="text-white">udynotion</h1>
               ...
               <div className="flex gap-x-10 item-center">
                   ...
                   }
                   {
                     token === null && (
                     <Link to="/login">
                        <button className="border rounded-r-md border-white bg-[#2C333F] px-[12px] py-[8px] text-white ml-9">
                              Login
                           </button>
                        </Link>
                     )
                   }
                   {
                     token === null && (
                     <Link to="/signup">
                        <button className="border border-white bg-[#2C333F] px-[12px] py-[8px] text-white">
                              Sign up
                           </button>
                        </Link>
                     )
