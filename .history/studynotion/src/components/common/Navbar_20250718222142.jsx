                             ...
                             <li key={index}> 
                                 {
                                    ...
                                    <div>
                                         <p>{link.title}</p>
                                          ...
                                          <div className="invisible absolute left-[50%] top-[50%] flex flex-col rounded-md bg-blend-color p-4 text-black opacity-0 transition-all duration-200 group-first:" >
