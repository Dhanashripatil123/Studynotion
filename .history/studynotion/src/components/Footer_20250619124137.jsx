           ...
           <div className="lg:w-[50%] flex flex-wrap flex-col justify-between">
            {/* <logo> */}
             ...
             <div className="flex flex-col items-center mr-80">
                    ...
                    <p className="text-[#2C333F]">About</p>  
                     <p className="text-[#2C333F]">camera</p>  
                     <p className="text-[#2C333F]">adfgifj</p>  
                     <div>
                     <FaGoogle className="text"></FaGoogle>
