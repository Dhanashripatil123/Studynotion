             ...
             <div className="flex flex-row">
                <img
                  ...
                  <div className="flex flex-col items-center">
                     ...
                     <div className="flex flex-col w-[30%] ml-20">
                  ...
                  <div className="gap-12">
                        <div className="flex flex-col w-[30%] gap-x-3 text-align ml-20">
                        ...
                        <div className="flex flex-col w-[30%] gap-x-3 mt-7 ml-17">
                     ...
                     <div className="flex  flex-row gap-6 ml-17">
