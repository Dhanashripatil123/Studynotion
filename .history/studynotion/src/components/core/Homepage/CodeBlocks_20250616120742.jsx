       ...
       <div className={`flex ${position} my-20 justify-between gap-10 `}>
           ...
           <div className='w-[50%] flex flex-col gap-8'>
            ...
            <div className='h-fit flex flex-row text-10[px] w-[100%] py-4  lg:w-[500px]'>
                {/* {HW -> BG gradient} */}
                <div className='rounded-bl-lg bg-yellow-50'>
                    {backgroundGradient}
                </div>
                ...
                <div className={`w-[90%] flex flex-col gap-2 font-bold font-mono text-yellow-200 pr-2bg-gradient-radial from-yellow-100 via-yellow-300 to-transparent`}>
                     <TypeAnimation 
