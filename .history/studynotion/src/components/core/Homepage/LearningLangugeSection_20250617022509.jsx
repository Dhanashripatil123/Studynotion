               ...
               <div className="flex flex-col gap-5 ">   
                   ...
                   <div className="flex flex-row items-center gap-5 justify-center mt-5">
                      <img src={know_your_progress} class="w-70 h-80" alt="KnowYourProgressImage" className="object-contain "/>
                       <img src={compare_with_others} class="w-" alt="KnowYourProgressImage" className="object-contain "/>
                       <img src={plan_your_lesson}   alt="KnowYourProgressImage" className="object-contain "/>
                    </div>
