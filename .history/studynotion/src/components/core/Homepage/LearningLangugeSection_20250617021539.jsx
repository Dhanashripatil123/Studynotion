             ...
             <div className="mt-[130px] mb-32">
               <div className="flex flex-col gap-5 ">   
                   ...
                   <div className="flex flex-row items-center justify-center mt-5">
                      <img src={know_your_progress} alt="KnowYourProgressImage" className="object-contain "/>
                       {/* <img src={compare_with_others} alt="KnowYourProgressImage" className="object-contain "/> */}
                       <img src={plan_your_lesson} className="w-40 h-80" alt="KnowYourProgressImage" className="object-contain ml-32"/>
                    </div>
