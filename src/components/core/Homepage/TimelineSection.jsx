             ...
             <div>
                         ...
                         <div className=' w-full md:w-[45%] flex flex-col gap-7'>
               {
                   timeline.map((element,index)=>{
                       return (
                            <div className='ml-9 mr-[-9] flex flex-row gap-6' key={index}>
                  ...
                  <div className='hidden md:block w-px h-40 bg-gray-300 mx-4' />

                 <div className='relative shadow-blue-200 md:w-[50%] w-full'>
                     <img src={TimelineImage} alt='TimelineImage' className='shadow-white object-cover w-full h-[320px] rounded-lg' />

                <div className='absolute border-r-amber-100 bg-green-700 flex flex-row text-white uppercase'>
