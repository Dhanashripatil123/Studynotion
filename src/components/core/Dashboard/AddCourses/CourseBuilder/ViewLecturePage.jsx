...
const ViewLecturePage = () => {
  ...
  useEffect(() => {
    console.log('[ViewLecturePage] lectureFromState:', lectureFromState);
    ...
    // Accept multiple possible video keys from server/client: `videoUrl`, `video`, or Cloudinary-style objects
    const candidate = lectureFromState?.videoUrl || lectureFromState?.video || (lectureFromState?.video && lectureFromState.video.secure_url) || null;
    setVideoSrc(candidate || null);
  }, [lectureFromState]);
      ...
      {videoSrc ? (
        <div className="w-full max-w-4xl">
          <video
            ...
            onError={(e) => console.error('[ViewLecturePage] video element error', e)}
          >
