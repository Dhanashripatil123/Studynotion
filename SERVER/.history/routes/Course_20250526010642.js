...
//Update section
router.post("/UpdateSection",auth,isInstructor,createCourse)
//Delete section
router.post("/deleteSection",auth,isInstructor,createCourse)
//Edit sub section
router.post("/updateSubSection",auth,isInstructor,createCourse)
//Delete Sub Section
router.post("/deleteSubSection",auth,isInstructor,createCourse)
//Add a sub section to a section
router.post("/addSubSection",auth,isInstructor,createCourse)
