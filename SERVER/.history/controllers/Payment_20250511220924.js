...
exports.verifySignature=async(req,res)=>{
    ...
    const digest = shasum.digest('hex');//step3: when you run hashing algo on text and get sum output this output is called the digest (this is basically form of he)
};