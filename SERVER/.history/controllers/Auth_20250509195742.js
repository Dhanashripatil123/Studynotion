...
exports.signup = async (req,res) => {
     ...
     return res.status(500).json({
          success: false,
          message: 'user cannot be registre , please try again again',
     });
...
exports.changePassword = async (req, res) => {
   try{     
    ...
    //validation
        const updatepassword = bcrypt.hash(newpassword,8)
    ...
    const mailSender = async (password,updatepassword) => {
        try{
         ...
         let info = await transporter.sendMail({
             ...
             to: `${email}`,
             subject: `${title}`, 
             html: `your updated password ia here`                                         
         })
         console.log("your are password is change");
