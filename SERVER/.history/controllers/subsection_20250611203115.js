...
exports.creteSubSection = async(req,res)=>{
     try{
        ...
        const SubsectionDetails = await Subsection.create({
          ...
          //console.log(uploadDatails.secure_url);
        
        //update section with this sub section ObjectId
          const updateSubSection = await Section.findByIdAndUpdate(sectionId,
                                {$push:{
...
exports.updateSubSection =  async(req,res) => {
      try{
          ...
          //Update Date
           const Subsection = await Subsection.findByIdAndUpdate(SubsectionId, { SubsectionName }, { new: true }).populate("Subsection");
