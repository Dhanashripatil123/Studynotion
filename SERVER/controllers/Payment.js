            ...
            for (const id of courseIds) {
                try {
                    ...
                    if (!course) {
                        ...
                        const courseProgressDoc = await CourseProgressModel.create({
                            userId: userId,
                            courseId: course._id,
                            completeVideos: []
                        });
                    ...
                    await User.findByIdAndUpdate(userId, { $addToSet: { courses: course._id, courseProgress: courseProgressDoc._id } });
